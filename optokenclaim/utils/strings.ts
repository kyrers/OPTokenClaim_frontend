export const helpText = "1. EXP holders can call subscribe to register their EXP balance, which will be taken into account for the reward calculation of the current epoch; \n" +
    ...
    "If you subscribe and then earn more EXP, you can just resubscribe with your updated EXP balance. However, subscriptions are maxed at 99 EXP. \n\n" +
